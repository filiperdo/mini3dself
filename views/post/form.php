		...
		<div class="x_panel">
			...
			<div class="col-md-4 col-sm-4 col-lg-4 col-xs-12">
				...
				<ul class="jFiler-items-list jFiler-items-grid" style="padding: 0">
					...
					<li class="jFiler-item" id="<?php echo 'id-'.base64_encode($img);?>">
								...
								<div class="jFiler-item-assets jFiler-row">
									...
									<ul class="list-inline pull-right">
										...
										<li>
											...
											<a rel="<?php echo base64_encode($img);?>" href="#" class="btn delete btn-danger btn-xs"><i class="icon-jfi-trash jFiler-item-trash-action"></i> Deletar</a>
										</li>
									</ul>
								</div>
							</div>
