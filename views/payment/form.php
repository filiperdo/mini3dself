...
<div class="row">
	...
	<div class="x_title">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo URL; ?>payment">Listar Payment</a></li>
			<li class="active"><?php echo $this->title; ?></li>
		</ol>
	</div>

<form id="form1" name="form1" method="post" action="<?php echo URL;?>payment/<?php echo $this->action;?>/" class="form-horizontal">

<div class="row">

<div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
<input type="hidden" name="idPayment" value="<?=$this->obj->getId_payment()?>" />
...
<div class="form-group">
	<div class="col-sm-10  col-sm-offset-2">
		...
		<a href="<?php echo URL; ?>payment" class="btn btn-primary">Cancelar</a>
	</div>
</div>
