...
<div class="row">
	...
	<div class="x_title">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo URL; ?>permission">Listar Permission</a></li>
			<li class="active"><?php echo $this->title; ?></li>
		</ol>
	</div>

<form id="form1" name="form1" method="post" action="<?php echo URL;?>permission/<?php echo $this->action;?>/" class="form-horizontal">
...
<div class="form-group">
	<div class="col-sm-10  col-sm-offset-2">
		...
		<a href="<?php echo URL; ?>permission" class="btn btn-primary">Cancelar</a>
	</div>
</div>
