...
<script>
  ...
  <script type="text/javascript" src="<?php echo URL?>public/js/maps/jquery-jvectormap-world-mill-en.js"></script>
  <script type="text/javascript" src="<?php echo URL?>public/js/maps/jquery-jvectormap-us-aea-en.js"></script>
  <!-- pace -->
